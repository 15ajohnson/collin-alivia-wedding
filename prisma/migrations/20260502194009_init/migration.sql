...
CREATE TABLE "reservation_member" (
    ...
    "rehearsal_dinner_invited" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "rsvp_attendee" (
    ...
    CONSTRAINT "rsvp_attendee_brought_by_member_id_fkey" FOREIGN KEY ("brought_by_member_id") REFERENCES "reservation_member" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
