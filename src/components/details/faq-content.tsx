...
export default function FaqContent() {
  return (
    <div className="flex flex-col text-2xl tracking-wider text-center font-(family-name:--font-playfair-display)">
      <p>
      ...
      <div className="grid grid-cols-2 m-6">
        ...
        <div className="flex flex-col grow border-l">
          <Faq
          ...
          <Faq
            ...
            a="Please only bring those who are listed under your RSVP - dinner is plated and we will not have any extra seets for those not directly invited (including children)."
          />
        </div>
      </div>
    </div>
