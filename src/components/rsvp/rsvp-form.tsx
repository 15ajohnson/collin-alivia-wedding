...
export default function RSVPForm() {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener(OPEN_RSVP_DIALOG_EVENT, handleOpenRequest);
    return () =>
      window.removeEventListener(OPEN_RSVP_DIALOG_EVENT, handleOpenRequest);
  }, []);
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        {step === "already-submitted" && (
          <div className="flex flex-col gap-4">
            <p className="text-sm text-muted-foreground">
              We already have an RSVP on file for your reservation. If you need
              to make a change, please text Collin directly at 440-865-9314.
            </p>
            <DialogFooter>
              <Button
                className="w-full"
